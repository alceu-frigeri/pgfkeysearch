...
%%
%% This is version {1.4a} {2025/10/29}
%%
...
\end{tsremark}
\begin{tsremark}
  These commands aren't expandable, though, once retrieved, the returning macro can be used in an expandable context.
\end{tsremark}
\begin{tsremark}
...
\begin{tsremark}
  If \tsobj[marg]{key} isn't found, no assignment will be made to \tsobj[marg]{tl-var}) and no warning or error will be raised.
\end{tsremark}
\begin{tsremark}
